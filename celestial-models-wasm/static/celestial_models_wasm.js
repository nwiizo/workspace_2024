...
const CelestialModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_celestialmodel_free(ptr >>> 0, 1));
...
export class CelestialModel {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        CelestialModelFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_celestialmodel_free(ptr, 0);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     */
    constructor(canvas) {
        const ret = wasm.celestialmodel_new(canvas);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        CelestialModelFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    draw_frame() {
        wasm.celestialmodel_draw_frame(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('celestial_models_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
