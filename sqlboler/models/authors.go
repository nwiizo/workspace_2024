...
var AuthorWhere = struct {
	...
	AuthorID: whereHelperint{field: "\"authors\".\"author_id\""},
...
var (
	authorAllColumns            = []string{"author_id", "name"}
	authorColumnsWithoutDefault = []string{"name"}
	authorColumnsWithDefault    = []string{"author_id"}
...
func (o *Author) Books(mods ...qm.QueryMod) bookQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"books\".\"author_id\"=?", o.AuthorID),
	)
...
func FindAuthor(ctx context.Context, exec boil.ContextExecutor, authorID int, selectCols ...string) (*Author, error) {
	authorObj := &Author{}
...
func AuthorExists(ctx context.Context, exec boil.ContextExecutor, authorID int) (bool, error) {
	var exists bool
