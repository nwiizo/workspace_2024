...
type User struct {
	...
	GivenName        string    `boil:"given_name" json:"given_name" toml:"given_name" yaml:"given_name"`
...
var UserWhere = struct {
	...
	FamilyName:       whereHelperstring{field: "\"users\".\"family_name\""},
	GivenName:        whereHelperstring{field: "\"users\".\"given_name\""},
}
...
func (r *userR) GetLoans() LoanSlice {
	if r == nil {
		return nil
	}
	return r.Loans
...
var (
	userAllColumns            = []string{"user_id", "email_address", "registration_date", "family_name", "given_name"}
	userColumnsWithoutDefault = []string{"email_address", "registration_date", "family_name", "given_name"}
...
func (o *User) Loans(mods ...qm.QueryMod) loanQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"loans\".\"user_id\"=?", o.UserID),
	)
...
func (userL) LoadLoans(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`loans`),
		qm.WhereIn(`loans.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddLoans(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Loan) error {
	var err error
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.UserID, rel.LoanID}
